...
GLfloat fbX = 1, fbY = 1, mbX = 1, mbY = 1;
...
void introduction()
{
    ...
    // Story Title
    print("The Journey of Educational System",
          1, 1, 1, title_fade, 200, 380, .3, .3, 2);
    print("by Ahmed,Faysal(15-28335-1)",
          1, 1, 1, title_fade, 668, 335, .15, .15, 1);
    print("Benazir,Neephat(15-28312-1)",
          1, 1, 1, title_fade, 715, 310, .15, .15, 1);
    print("Rayhan,MD.Saif Siddiquee(15-28295-1)",
          1, 1, 1, title_fade, 715, 285, .15, .15, 1);
...
void update(int)
{
    ...
    if (SCENE_ID == 1)
    {
        if(birth_bubble1_text <1)
            birth_bubble1_text += 0.005;

        if(birth_bubble2_text <1)
            birth_bubble2_text += 0.005;
        else
        {
    ...
    if (SCENE_ID == 3)
    {
        if (gs_subtitle_1_appear < 1)
            gs_subtitle_1_appear += .005;
...
//            }
    ...
    // Pre University Coaching Title Screen
    if (SCENE_ID == 10)
    {
    ...
    // Engineering University Title Screen
    if (SCENE_ID == 12)
    {
